#
#  Be sure to run `pod spec lint SwiftPersianTools.podspec' to ensure this is a
...
a framework of a variety of tools for the Persian language in swift, convert numbers, add pricing, ...                  			
  ...
  spec.author             = { "Saeedrz" => "saeed.rezaei.sa@gmail.com" }
  # Or just: spec.author    = "Saeedrz"
  # spec.authors            = { "Saeedrz" => "saeed.rezaei.sa@gmail.com" }
  spec.social_media_url   = "https://twitter.com/SaeedRezaeii"
  ...
  spec.source_files  = "SwiftPersianTools", "SwiftPersianTools/**/*.{h,m,swift}"
